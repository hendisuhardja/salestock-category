...
function addRoutes(api) {
    ...
    api.get('/categories/:id/parents', getCategoryParents);
    api.get('/categories/:id/children', getCategoryChildren);
}
 ...
 * @param {Object} res - res.body contains the requested category
 */
function getCategoryParents(req, res) {
 ...
 * @param {Object} res - res.body contains the requested category
 */
function getCategoryChildren(req, res) {
